...
@interface LXTravelUserViewController () <UITableViewDataSource, UITableViewDelegate>
...
@implementation LXTravelUserViewController
...
- (void)loadUserProfileViewDatas {
    ...
    [urlStr replaceOccurrencesOfString:@"ID" withString:[NSString stringWithFormat:@"%@", self.userProfile_id] options:NSLiteralSearch range:NSMakeRange(0, urlStr.length)];
    // 3.发送请求
